...
/* 
   Included for SIR fault insertion
...
/* 
   Because the differences between v3 and v4
   are so scarce, faults are injected outside
   change boundaries on this function
